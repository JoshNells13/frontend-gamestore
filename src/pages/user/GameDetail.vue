  ...
  <main v-if="game">
    <div class="hero py-5 bg-light">
      <div class="container text-center">
        ...
        <h5 v-if="latestVersion" class="mt-2">
          Last Version {{ latestVersion.version }}
...
const latestVersion = computed(() => {
  if (!game.value?.versions?.length) return null
  return game.value.versions[game.value.versions.length - 1]
})
